            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <a href="#">
                                                <img src="{{asset('/assets/images/hot-deals/p13.jpg')}}" alt="">
                                                <img src="{{asset('/assets/images/hot-deals/p13_hover.jpg')}}" alt="" class="hover-image">
                                            </a>
                                        </div>
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <a href="#">
                                                <img src="{{asset('/assets/images/hot-deals/p14.jpg')}}" alt="">
                                                <img src="{{asset('/assets/images/hot-deals/p14_hover.jpg')}}" alt="" class="hover-image">
                                            </a>
                                        </div>
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <a href="#">
                                                <img src="{{asset('/assets/images/hot-deals/p15.jpg')}}" alt="">
                                                <img src="{{asset('/assets/images/hot-deals/p15_hover.jpg')}}" alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <div class="sale-offer-tag"><span>35%<br>
                    off</span></div>
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p5.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p9.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p11.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p13.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p12.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p1.jpg')}}"  alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p3.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p7.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                    ...
                    <div class="sidebar-widget product-tag">
                        ...
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="tag-list"> <a class="item" title="Phone" href="#">Rose</a> </div>
                            <!-- /.tag-list -->
                        </div>
                        <!-- /.sidebar-widget-body -->
                    </div>
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p8.jpg')}}"  alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p6.jpg')}}"  alt="image"> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p6.jpg')}}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p5.jpg')}}" alt="images">
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="#"> <img src="{{asset('/assets/images/products/p4.jpg')}}"  alt="">
                                                                    <div class="zoom-overlay"></div>
                                                                </a> </div>
                                                            <!-- /.image -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p1_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p4.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p4_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p3.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p3_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p2_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p6_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p5.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p5_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                        </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p7_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p8.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p8_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p9.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p9_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p10_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p11.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p11_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                <img src="{{asset('/assets/images/products/p12.jpg')}}" alt="">
                                                                <img src="{{asset('/assets/images/products/p12_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p15_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                                                ...
                                                <div class="product">
                                                    <div class="image">
                                                        <a href="#">
                                                            ...
                                                            <img src="{{asset('/assets/images/products/p14_hover.jpg')}}" alt="" class="hover-image">
                                                        </a>
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="#">
                                                                ...
                                                                <img src="{{asset('/assets/images/products/p13_hover.jpg')}}" alt="" class="hover-image">
                                                            </a>
                    ...
                    <div class="wide-banners outer-bottom-xs">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="wide-banner cnt-strip">
                                    <div class="image"> <img class="img-responsive" src="{{asset('/assets/images/banners/home-banner3.jpg')}}" alt=""> </div>
                                </div>
                                <!-- /.wide-banner -->
                            </div>
                    ...
                    <div class="wide-banners outer-bottom-xs">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="wide-banner cnt-strip">
                                    <div class="image"> <img class="img-responsive" src="{{asset('/assets/images/banners/home-banner4.jpg')}}" alt=""> </div>
                        ...
                        <div class="blog-slider-container outer-top-xs">
                            <div class="owl-carousel blog-slider custom-carousel">
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="#"><img src="{{asset('/assets/images/blog-post/blog_big_01.jpg')}}" alt=""></a> </div>
                                        </div>
                                        <!-- /.blog-post-image -->
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="#"><img src="{{asset('/assets/images/blog-post/blog_big_02.jpg')}}" alt=""></a> </div>
                                        </div>
                                        <!-- /.blog-post-image -->
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="#"><img src="{{asset('/assets/images/blog-post/blog_big_03.jpg')}}" alt=""></a> </div>
                                        </div>
                                        <!-- /.blog-post-image -->
